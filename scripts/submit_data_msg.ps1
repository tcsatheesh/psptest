...
param(
    ...
    [Parameter()]
    [string]$blob_name = "msg_loader.py",
    ...
    [Parameter()]
    [string]$checkpoint_path = "checkpoint/msgdata",
...
$name = "msg_loader max_trigger:$max_per_trigger, processing_time:$processing_time_in_seconds seconds"
